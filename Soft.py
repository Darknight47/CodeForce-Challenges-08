"""
----------- Link for the challenge: https://codeforces.com/problemset/problem/151/A ---------------
...
Input
The first and only line contains positive integers n, k, l, c, d, p, nl, np, not exceeding 1000 and 
no less than 1. The numbers are separated by exactly one space.
...
slices = c * d
salt = p // np
print(min(milliliters, slices, salt) // n)
