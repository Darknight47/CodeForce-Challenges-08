"""
----------- Link for the challenge: https://codeforces.com/problemset/problem/1878/A --------------
...
(1 ≤ t ≤ 1000) — the number of test cases. The description of test cases follows.

The first line of each test case contains two integers n and k
(1 ≤ n ≤ 100, 1 ≤ k ≤ 100) — the number of elements in array and the element which must be the most common.

The second line of each test case contains n
integers a1, a2, a3, …, an (1 ≤ ai ≤ 100) — elements of the array.
...
for i in range(cases):
    ...
    print("YES" if arr.count(k) > 0 else "NO")