"""
--------- Link for the challenge: https://codeforces.com/contest/1807/problem/A --------
...
The additional constraint on the input: it will be generated so that exactly one of the two 
